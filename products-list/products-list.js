...
function setupData() {
  ...
  query.find().then(function (products) {
    products.forEach(function(product) {
	  ...
	  var productDatai = product.get('datain');
	  var productDatao = product.get('datao');
	  var productDataie = product.get('datainexample');
	  var productDataoe = product.get('dataoexample');
	  var productDatahint = product.get('datahint');
